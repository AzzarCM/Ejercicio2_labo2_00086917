...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int [] ArrayImagenes = {R.drawable.draven, R.drawable.fizz, R.drawable.jhin, R.drawable.jinx, R.drawable.leona, R.drawable.syndra, R.drawable.talon, R.drawable.vayne
        ,R.drawable.zed};
        int viewId = v.getId();
